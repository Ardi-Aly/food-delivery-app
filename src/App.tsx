        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="relative">
              <button onClick={() => setCurrentScreen('cart')} className="p-2 hover:bg-gray-100 rounded-full transition-colors">
  ...
  const CartScreen = () => (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white px-4 lg:px-6 py-6 shadow-sm sticky top-0 z-50">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center">
            <button onClick={() => setCurrentScreen('home')} className="mr-4 hover:bg-gray-100 p-2 rounded-full transition-colors">
  ...
  const CheckoutScreen = () => (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white px-4 lg:px-6 py-6 shadow-sm sticky top-0 z-50">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center">
            <button onClick={() => setCurrentScreen('cart')} className="mr-4 hover:bg-gray-100 p-2 rounded-full transition-colors">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
              </svg>
            </button>
